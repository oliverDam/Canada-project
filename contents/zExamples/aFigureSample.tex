...
%%new way to inset two pictures alongside each other. updated 13/12/2018
\begin{figure}[H]
	\hfill
	{%
		\begin{minipage}{0.46\linewidth}
			\includegraphics[width=\linewidth]{figures/zExamples/filename}
			\caption{leave blank} %leave some text there or the figures will move slightly relative to each other
			\label{fig:Picture1}
		\end{minipage}
	}\hfill
	{%
		\begin{minipage}{0.46\linewidth}
			\includegraphics[width=\linewidth]{figures/zExamples/filename}
			\caption{leave black} %leave some text there or the figures will move slightly relative to each other
			\label{fig:Picture2}
		\end{minipage}
	}%\hfill\strut
