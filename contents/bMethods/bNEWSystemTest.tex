...
As it can be seen from the results none of the sensors are broken, however FSR number 3 (FSR3), located at the heel of the right foot, returns a lower resistance when applied a 1kg weight compared to the other FSRs. 
